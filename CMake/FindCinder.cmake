...
if(MSVC)
    set(Cinder_LIB_NAME "cinder.lib")
    set(Cinder_DEBUG_LIB_NAME "cinder_d.lib")
    set(Cinder_LIB_PREFIX "msw/x64")
else()
    set(Cinder_LIB_NAME "libcinder.a")
    set(Cinder_DEBUG_LIB__NAME "libcinder_d.a")
    set(Cinder_LIB_PREFIX "macosx")
endif()

message(STATUS "${Cinder_LIB_NAME} / ${Cinder_ROOT_DIR}/lib")
find_library(Cinder_LIBRARY_RELEASE ${Cinder_LIB_NAME} HINTS "${Cinder_ROOT_DIR}/lib")
find_library(Cinder_LIBRARY_DEBUG ${Cinder_DEBUG_LIB_NAME} HINTS "${Cinder_ROOT_DIR}/lib")

if(CMAKE_BUILD_TYPE=="DEBUG")
    set(Cinder_LIBRARIES ${Cinder_LIBRARY_DEBUG})
else()
    set(Cinder_LIBRARIES ${Cinder_LIBRARY_RELEASE})
endif()

#Find Boost
if(MSVC)
  set(BOOST_LIBRARYDIR "${Cinder_ROOT_DIR}/lib/msw")
  set(_boost_components filesystem regex system thread)
else()
  set(BOOST_LIBRARYDIR "${Cinder_ROOT_DIR}/lib/macosx")
  set(_boost_components filesystem system)
endif()
